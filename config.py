...
“field_updates”:        f”{DG_BASE}/field-updates”,
“dg_rankings”:          f”{DG_BASE}/preds/get-dg-rankings”,
“pre_tournament_preds”: f”{DG_BASE}/preds/pre-tournament”,
“skill_decompositions”: f”{DG_BASE}/preds/player-decompositions”,
...
ODDS_SPORT  = “golf_pga_championship”   # Fallback — queried dynamically each week

# Common Odds API golf sport keys:

# golf_masters_tournament_winner, golf_pga_championship,

# golf_us_open, golf_the_open_championship,

# golf_pga_tour (some regular events)

# The system queries /sports each run to find the active golf event
